...
export default class GiveStuffStep1 extends Component {
    ...
    handleClick = (e) => {
        if (this.state.choice1 || this.state.choice2 || this.state.choice3 || this.state.choice4 || this.state.choice5) {
            this.props.changeStep('step1', null);
            this.props.changeStep('step2', 'active');
        }
    };
    ...
    render() {
        console.log('co');
        return (
            <section className="give-stuff-step give-stuff-step-1">
                        ...
                        <div className="give-stuff-step__box--inputs">
                            ...
                            <div className="box__input-container">
                                <label className="box__input--text">
                                    <input onClick={this.setValue} data-info='choice1' className='box__input'
                                           type='checkbox'/>
                            ...
                            <div className="box__input-container">
                                ...
                                <label className="box__input--text">
                                    <input onClick={this.setValue} data-info='choice2' className='box__input'
                                           type='checkbox'/>
                            ...
                            <div className="box__input-container">
                                <label className="box__input--text">
                                    <input onClick={this.setValue} data-info='choice3' className='box__input'
                                           type='checkbox'/>
                                    <span
                            ...
                            <div className="box__input-container">
                                ...
                                <label className="box__input--text">
                                    <input onClick={this.setValue} data-info='choice4' className='box__input'
                                           type='checkbox'/>
                                    <span
                            ...
                            <div className="box__input-container">
                                <label className="box__input--text">
                                    <input onClick={this.setValue} data-info='choice5' className='box__input'
                                           type='checkbox'/>
